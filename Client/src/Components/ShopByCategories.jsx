    ...
    return (
        ...
        >
            ...
            <div className="cats-wrapper">
                <ShopByCatsCard name={'Home'} />
                <ShopByCatsCard name={'Electronics'} />
                <ShopByCatsCard name={'Smartphones'} />
                <ShopByCatsCard name={'Shoes'} />
                <ShopByCatsCard name={'Outerwear'} />
                <ShopByCatsCard name={'Laptops'} />
            </div>
        </div>
    )
}