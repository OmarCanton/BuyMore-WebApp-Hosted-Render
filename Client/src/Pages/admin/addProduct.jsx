...
export default function AddProduct() {
    ...
    return (
        ...
        >
            ...
            >
                <h2 style={{color: theme === 'dark' && 'white'}}>Add Product</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="name" placeholder="iPhone 17 Air" value={formData.name} onChange={handleChange} />
                    </div>

                    {/* Brand */}
                    <div className="form-group">
                        <label style={{color: theme === 'dark' && 'white'}}>Brand</label>
                        <input type="text" name="brand" placeholder="Apple" value={formData.brand} onChange={handleChange} />
                    </div>
                    ...
                    <div className="form-row">
                        <div className="form-group">
                            ...
                            <input type="number" placeholder="300" min={1} name="actualPrice" value={formData.actualPrice} onChange={handleChange} />
                        </div>
                        <div className="form-group">
                            <label style={{color: theme === 'dark' && 'white'}}>Old Price</label>
                            <input type="number" placeholder="370" name="prevPrice" value={formData.prevPrice} onChange={handleChange} />
                        </div>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea name="description" placeholder="Description of product" value={formData.description} onChange={handleChange}></textarea>
                    </div>
