...
export default function Account () {
    ...
    const changeUsername = async () => {
        try {
            const response = await axios.post(`http://localhost:3000/changeUsername/${userId}`, {updatedUsername}, {withCredentials: true})
    ...
    const updatePhone = async () => {
        try {
            const response = await axios.post(`http://localhost:3000/updatePhone/${userId}`, {updatedPhone}, {withCredentials: true})
            if(response.data.success === true) {
    ...
    const updateAbout = async () => {
        setAboutOpen(false)
        try {
            const response = await axios.post(`http://localhost:3000/updateAbout/${userId}`, {updatedAbout}, {withCredentials: true})
            if(response.data.success === true) {
    ...
    const updateProfilePicture = async (e) => {
        ...
        if(file) {
            ...
            try {
                const response = await axios.post(`http://localhost:3000/updateProfilePicture/${userId}`, formData, {
    ...
    const deleteProfilePicture = async () => {
        ...
        setViewOps(false)
        try {
            const response = await axios.post(`http://localhost:3000/deleteProfilePicture/${userId}`)
    ...
    const delUser = async (e) => {
        ...
        setDelAccOpen(false)
        try {
            const response = await axios.post (`http://localhost:3000/delUser/${userId}`, { password })
    ...
    const resetPassword = async (e) => {
        ...
        try {
            const response = await axios. post('http://localhost:3000/forgot-password', {resetEmail})
            if(response.data.success) {
                toast.success(response.data.message, {
                    style: {
                        backgroundColor: 'black',
